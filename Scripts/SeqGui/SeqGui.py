...
from several codon tables which are implemented in Wildlife.
...
main_window = tk.Tk()
main_window.title("Greetings from Wildlife")
...
# Import actual codon tables from Wildlife and sort alphabetically
