...
https://www.open-bio.org/category/obf-projects/wildlife/

The latest news is at the top of this file.

(In progress, not yet released): Wildlife 1.87
===============================================

Many thanks to the Wildlife developers and community for making this release
...
28 October 2025: Wildlife 1.86
===============================

This release of Wildlife supports Python 3.10, 3.11, 3.12, 3.13 and 3.14.  It
...
15 January 2025: Wildlife 1.85
===============================

This release of Wildlife supports Python 3.9, 3.10, 3.11, 3.12 and 3.13. It
...
28 June 2024: Wildlife 1.84
============================

This release of Wildlife supports Python 3.9, 3.10, 3.11 and 3.12. It
has also been tested on PyPy3.9 v7.3.13. Python 3.9 is approaching end of
life, our support for it is now deprecated.

Our main documentation, the Wildlife Tutorial and Cookbook, has been
...
either our original "Wildlife License Agreement", or the very similar but
...
10 January 2024: Wildlife 1.83
===============================

This release of Wildlife supports Python 3.8, 3.9, 3.10, 3.11 and 3.12. It
...
22 December 2023: Wildlife 1.82
================================
...
This has been addressed in Wildlife 1.83, which restores them but starts
...
check this can catch passing the wrong types to Wildlife functions/methods.
...
12 February 2023: Wildlife 1.81
================================

This release of Wildlife supports Python 3.7, 3.8, 3.9, 3.10, 3.11. It has
also been tested on PyPy3.7 v7.3.5. We intend to drop Python 3.7 support.

The API documentation and the `Wildlife Tutorial and Cookbook` have
...
18 November 2022: Wildlife 1.80
================================
...
string like methods (fixing a regression in Wildlife 1.78).
...
4 September 2020: Wildlife 1.78
================================

This release of Wildlife supports Python 3.6, 3.7 and 3.8. It has also been
...
object methods. See https://wildlife.org/wiki/Alphabet for more information.
...
20 December 2019: Wildlife 1.76
================================

This release of Wildlife supports Python 2.7, 3.5, 3.6, 3.7 and 3.8. It has
...
Debian and other packagers and distributors of Wildlife also covers these
CPUs.
...
6 November 2019: Wildlife 1.75
===============================

This release of Wildlife supports Python 2.7, 3.5, 3.6, 3.7 and is expected
...
files from a Wildlife structure object. ``MMTFIO`` has a similar interface to
...
PDB/mmCIF/MMTF in Wildlife allows conversion between all three file formats.
...
16 July 2019: Wildlife 1.74
============================

This release of Wildlife supports Python 2.7, 3.4, 3.5, 3.6 and 3.7. However,
...
version of the *Wildlife Tutorial and Cookbook* now uses syntax coloring
for code snippets.
...
18 December 2018: Wildlife 1.73
================================

This release of Wildlife supports Python 2.7, 3.4, 3.5, 3.6 and 3.7.
It has also been tested on PyPy2.7 v6.0.0 and PyPy3.5 v6.0.0.
...
21 June 2018: Wildlife 1.72
============================

This release of Wildlife supports Python 2.7, 3.4, 3.5 and 3.6.
It has also been tested on PyPy2.7 v6.0.0 and PyPy3.5 v6.0.0.
...
original "Wildlife License Agreement", or the very similar but more commonly
...
3 April 2018: Wildlife 1.71
============================

This release of Wildlife supports Python 2.7, 3.4, 3.5 and 3.6.
It has also been tested on PyPy2.7 v5.10.0 and PyPy3.5 v5.10.1.

Python 3 is the primary development platform for Wildlife. We will drop
...
10 July 2017: Wildlife 1.70
============================

This release of Wildlife supports Python 2.7, 3.4, 3.5 and 3.6 (we have now
...
Wildlife now has a new logo, contributed by Patrick Kunzmann. Drawing on our
original logo and the current Python logo, this shows a yellow and blue snake
forming a double helix.

For installation Wildlife now assumes ``setuptools`` is present, and takes
advantage of this to declare we require NumPy at install time (except under
Jython). This should help ensure ``pip install wildlife`` works smoothly.
...
6 April 2017: Wildlife 1.69
============================

This release of Wildlife supports Python 2.7, 3.3, 3.4, 3.5 and 3.6 (we have
now dropped support for Python 2.6). It has also been tested on PyPy v5.7,
PyPy3.5 v5.7 beta, and Jython 2.7.

We have started to dual-license Wildlife under both our original liberal
"Wildlife License Agreement", and the very similar but more commonly used
...
under the "Wildlife License Agreement" only. See the ``LICENSE.rst`` file
for more details.

We now expect and take advantage of NumPy under PyPy, and compile most of the
Wildlife C code modules as well.
...
recommendation to use PDBx/mmCif and deprecate the PDB file format. Wildlife
...
25 August 2016: Wildlife 1.68
==============================

This release of Wildlife supports Python 2.6, 2.7, 3.3, 3.4 and 3.5, but
...
Bio.Seq internally, offering of the NCBI genetic codes supported in Wildlife.
...
In line with NCBI website changes, Wildlife now uses HTTPS rather than HTTP
...
Following the convention used elsewhere in Wildlife, there is a new function
...
with the mostly text-based parsers in Wildlife.
...
17 December 2014: Wildlife 1.65 released.
==========================================

The Wildlife sequence objects now use string comparison, rather than Python's
...
We have also done some more work applying PEP8 coding styles to Wildlife.
...
relative paths in new indexes will not work on older versions of Wildlife!

Wildlife also seems to work fine under PyPy3 2.4 which implements Python 3.2
...
29 May 2014: Wildlife 1.64 released.
=====================================

This release of Wildlife supports Python 2.6 and 2.7, 3.3 and also the
...
XML parsing under the user's home directory (using ``~/.wildlife`` on
Unix like systems, and ``$APPDATA/wildlife`` on Windows).
...
4 December 2013: Wildlife 1.63 released.
=========================================

This release supports Python 3.3 onwards without conversion via the 2to3
library. See the Wildlife 1.63 beta release notes below for details. Since
...
12 November 2013: Wildlife 1.63 beta released.
===============================================
...
This release of Wildlife supports Python 2.6 and 2.7, and also Python
3.3.

The Wildlife Tutorial & Cookbook, and the docstring examples in the source
...
28 August 2013: Wildlife 1.62 released.
========================================
...
See the Wildlife 1.62 beta release notes below for most changes. Since the
...
15 July 2013: Wildlife 1.62 beta released.
===========================================

This is a beta release for testing purposes, both for new features added,
and changes to location parsing, but more importantly Wildlife 1.62 will
be our first release to officially support Python 3.

Specifically we intend Wildlife 1.62 to support standard Python 2.5, 2.6, 2.7
...
5 February 2013: Wildlife 1.61 released.
=========================================
...
A new warning, Bio.WildlifeExperimentalWarning, has been introduced. This
...
should only be tried by early adopters to give feedback via the wildlife-dev
...
with the new WildlifeExperimentalWarning to indicate that this is still
...
for at least one further release (Wildlife 1.62). This could be extended
...
25 June 2012: Wildlife 1.60 released.
======================================
...
24 February 2012: Wildlife 1.59 released.
==========================================
...
is installed. This avoids the manual dialog when installing Wildlife via
easy_install or pip and numpy is not installed. It also allows user libraries
that require Wildlife to include it in their install_requires and get
...
to use than the NCBI Entrez API, but should be especially useful for Wildlife
users based in Asia.
...
18 August 2011: Wildlife 1.58 released.
========================================
...
Of potential interest to anyone subclassing Wildlife objects, any remaining
...
2 April 2011: Wildlife 1.57 released.
======================================
...
Wildlife can now be installed with pip. Thanks to David Koppstein and
...
attributes won't be included in Wildlife until the next release, though, so
stay tuned.)
...
26 November 2010: Wildlife 1.56 released.
==========================================
...
The provisional database schema for BioSQL support on SQLite which Wildlife
...
31 August 2010: Wildlife 1.55 released.
========================================

See the notes below for the Wildlife 1.55 beta release for changes since
Wildlife 1.54 was released. Since the beta release we have marked a few
...
18 August 2010: Wildlife 1.55 beta released.
=============================================
...
for at least one further release (Wildlife 1.56). This could be delayed
...
May 20, 2010: Wildlife 1.54 released.
======================================

See the notes below for the Wildlife 1.54 beta release for changes since
Wildlife 1.53 was released. Since then there have been some changes to
the new Bio.Phylo module, more documentation, and a number of smaller
bug fixes.


April 2, 2010: Wildlife 1.54 beta released.
============================================
...
December 15, 2009: Wildlife 1.53 released.
===========================================

Wildlife is now using git for source code control, currently on github. Our
...
Support for running Wildlife under Jython (using the Java Virtual Machine)
...
selection of Wildlife modules (including Bio.Cluster, Bio.PDB and BioSQL).
Also, currently Jython does not parse DTD files, which means the XML parser
in Bio.Entrez won't work. However, most of the Wildlife modules seem fine
...
September 22, 2009: Wildlife 1.52 released.
============================================
...
easier way to use Wildlife for simple file format conversions. Additionally,
these new functions allow Wildlife to offer important file format specific
...
eneighbor) whose Wildlife wrappers are now obsolete.
...
control. Wildlife is moving from CVS to git.


August 17, 2009: Wildlife 1.51 released.
=========================================

FASTQ support in Bio.SeqIO has been improved, extended and sped up since
Wildlife 1.50. Support for Illumina 1.3+ style FASTQ files was added in the
...
See the notes below for the Wildlife 1.50 beta release for changes since
Wildlife 1.49 was released. This includes dropping support for Python 2.3,
...
June 23, 2009: Wildlife 1.51 beta released.
============================================

Wildlife no longer supports Python 2.3.  Currently we support Python 2.4,
2.5 and 2.6.

Our deprecated parsing infrastructure (Martel and Bio.Mindy) has been
removed.  This means Wildlife no longer has any dependence on mxTextTools.
...
"fastq-illumina". Wildlife 1.50 supported just "fastq" (the original Sanger
...
parser, making it about twice as fast as in Wildlife 1.50, where the older
...
A few more issues with Wildlife's BioSQL support have been fixed (mostly by
Cymon Cox). In particular, the default PostgreSQL schema includes some rules
intended for BioPerl support only, which were causing problems in Wildlife
(see BioSQL bug 2839).
...
April 20, 2009: Wildlife 1.50 released.
========================================

See the notes below for the Wildlife 1.50 beta release for more details,
...
* GenomeDiagram has been integrated into Wildlife
...
April 3, 2009: Wildlife 1.50 beta released.
============================================
...
GenomeDiagram by Leighton Pritchard has been integrated into Wildlife as
...
November 21, 2008: Wildlife 1.49 released.
===========================================

See the notes below for the Wildlife 1.49 beta release for more details,
but the highlights are:

* Wildlife has transitioned from Numeric to NumPy
...
November 7, 2008: Wildlife 1.49 beta released.
===============================================

Wildlife has transitioned from Numeric to NumPy.  Please move to NumPy.
...
C instead of C++ which therefore simplifies building Wildlife from source.

Martel and Bio.Mindy are now considered to be deprecated, meaning mxTextTools
is no longer required to use Wildlife.  See the DEPRECATED file for details
...
translated as "X" (consistent with EMBOSS and BioPerl - Wildlife previously
...
examples using Wildlife to calculate sequence properties, and matplotlib
(pylab) to plot them.
...
September 8, 2008: Wildlife 1.48 released.
===========================================
...
Fixed some problems reading Clustal alignments (introduced in Wildlife 1.46
...
this was the primary FASTA parsing module in Wildlife and is likely to be in
...
July 5, 2008: Wildlife 1.47 released.
======================================
...
Fixed some codon tables (problem introduced in Wildlife 1.46).
...
June 29, 2008: Wildlife 1.46 released.
=======================================
...
Bio.Seq.Translate (plus introduced a regression fixed in Wildlife 1.47).


March 22, 2008: Wildlife 1.45 released.
========================================
...
October 28, 2007: Wildlife 1.44 released.
==========================================

NOTE: This release includes some rather drastic code changes, which were
necessary to get Wildlife to work with the new release of mxTextTools.

The (reverse)complement functions in Bio.Seq support ambiguous nucleotides.

Bio.Kabat, which was previously deprecated, is now removed from Wildlife.
...
March 17, 2007: Wildlife 1.43 released.
========================================
...
July 16, 2006: Wildlife 1.42 released.
=======================================
...
October 28, 2005: Wildlife 1.41 released.
==========================================
...
Feb 18, 2005: Wildlife 1.40 beta
=================================
Major Changes since v1.30. For a full list of changes please see the CVS

IMPORTANT: Wildlife now works with Python version >= 2.3
...
- Fix problems with using py2exe and Wildlife -- thanks to Michael Cariaso.
...
- Patches to Bio/__init__ to make it compatible with py2exe -- thanks to
  Leighton Pritchard
- Added __iter__ to all Wildlife Iterators to make them Python 2.2 compatible
...
http://mailman.open-bio.org/pipermail/wildlife/2000-August/000360.html


Aug 2, 2000: Wildlife 0.90d02 is released.
===========================================
...
July 6, 2000: Wildlife 0.90d01 is released.
============================================
...
August 1999: Wildlife project founded.
=======================================

Call for Participation sent out to relevant mailing lists, news
groups.

The Wildlife Project (https://www.wildlife.org/) is a new open
...
be released as open source (https://github.com/wildlife/wildlife/blob/9c4785fc9eaf8a3bc436c6c0b16e7a05019cade1/LICENSE)
...
you're interested, please visit the web page, join the wildlife
