...
http://wildlife.org/wiki/Contributing for a general overview about
...
Wildlife is moving towards dual licensing the code. In your git commit and/or
pull request, please explicitly state that you agree to your contributions
being dual licensed under *both* our original "Wildlife License Agreement"
...
We have a git introduction online at http://wildlife.org/wiki/GitUsage
...
Wildlife tries to follow the coding conventions laid out in PEP8 and PEP257,
...
chapter in the Wildlife Tutorial for more information on our test framework:
http://wildlife.org/DIST/docs/tutorial/Tutorial.html
...
automatically hooks into git. When you run "git commit" within the wildlife
...
this, run::
    ...
    # Activate pre-commit for wildlife
    $ cd wildlife-repository
    $ pre-commit install
...
Have a look at the `related chapter <http://wildlife.org/DIST/docs/tutorial/Tutorial.html#chapter%3Atesting>`_ in the documentation for more details.
...
request. These will run most of the Wildlife tests (although not with all the
...
CodeCov: https://codecov.io/github/wildlife/wildlife/
...
Contributing to the Wildlife Tutorial
--------------------------------------

For instructions, see `the Wildlife Tutorial README <Doc/README.rst>`_
