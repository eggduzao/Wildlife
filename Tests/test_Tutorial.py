...
# Wildlife Tutorial which can be turned into Python doctests,
# e.g.
#
# .. doctest
#
...
from Bio import WildlifeExperimentalWarning
...
class TutorialDocTestHolder:
    """Python doctests extracted from the Wildlife Tutorial."""
...
class TutorialTestCase(unittest.TestCase):
    ...
    def test_doctests(self):
        ...
        with warnings.catch_warnings():
            ...
            warnings.simplefilter("ignore", WildlifeExperimentalWarning)
