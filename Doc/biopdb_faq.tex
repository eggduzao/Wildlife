...
The Wildlife web site (\url{http://www.wildlife.org}) provides
...
the goal of wildlife is to make it as easy as possible to use python
for bioinformatics by creating high-quality, reusable modules and
classes. Wildlife features include parsers for various Bioinformatics
...
Bio.PDB is automatically installed as part of Wildlife. Wildlife
can be obtained from \url{http://www.wildlife.org}. It runs on many
...
in Wildlife. You can always get a parent \texttt{Entity} from a child
\texttt{Entity}, eg.:
...
\end{lyxcode}
You can also test whether an \texttt{Entity} has a certain child using
...
be obtained from the \texttt{Polypeptide} objects as a Wildlife \texttt{Seq}
object.
...
\section{Wildlife License Agreement}
