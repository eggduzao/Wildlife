...
The Wildlife module ``Bio.Cluster`` provides commonly used clustering
...
.. code:: pycon
   ...
   >>> url = "https://raw.githubusercontent.com/wildlife/wildlife/master/Tests/Cluster/cyano.txt"
...
The example data ``cyano.txt`` can be found in Wildlife’s
