...
The ``Bio.Graphics.GenomeDiagram`` module was added to Wildlife 1.50,
having previously been available as a separate Python module dependent
on Wildlife. GenomeDiagram is described in the Bioinformatics journal
...
http://wildlife.org/DIST/docs/GenomeDiagram/userguide.pdf which has
some more examples.
...
Microtus*, the file is included with the Wildlife unit tests under the
GenBank folder, or online
`NC_005816.gb <https://raw.githubusercontent.com/wildlife/wildlife/master/Tests/GenBank/NC_005816.gb>`__
from our website.
...
when GenomeDiagram was added to Wildlife 1.50:
...
Wildlife 1.61 added three more sigils,
...
Wildlife 1.61 adds a new ``BIGARROW`` sigil which always straddles the
...
different lengths (this requires Wildlife 1.59 or later).
...
Wildlife 1.59 added the ability to draw cross links between tracks -
...
`Proux_et_al_2002_Figure_6.py <https://github.com/wildlife/wildlife/blob/master/Doc/examples/Proux_et_al_2002_Figure_6.py>`__
included in the ``Doc/examples`` folder of the Wildlife source code) to
...
There is still a lot more that can be done within Wildlife to help
...
`Proux_et_al_2002_Figure_6.py <https://github.com/wildlife/wildlife/blob/master/Doc/examples/Proux_et_al_2002_Figure_6.py>`__
included in the ``Doc/examples`` folder of the Wildlife source code.
...
`User Guide
(PDF) <http://wildlife.org/DIST/docs/GenomeDiagram/userguide.pdf>`__
...
included with Wildlife then you will have to make a few changes - most
...
American spellings, although for several years the Wildlife version of
...
If you run into difficulties, please ask on the Wildlife mailing list
