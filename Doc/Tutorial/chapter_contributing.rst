...
Where to go from here – contributing to Wildlife
=================================================

Bug Reports + Feature Requests
------------------------------

Getting feedback on the Wildlife modules is very important to us.
...
the `Wildlife mailing list <http://wildlife.org/wiki/Mailing_lists>`__
and issues or pull requests on GitHub.

Additionally, if you think you’ve found a new bug, you can submit it to
our issue tracker at https://github.com/wildlife/wildlife/issues (this
...
We encourage all our uses to sign up to the main Wildlife mailing list.
Once you’ve got the hang of an area of Wildlife, we’d encourage you to
...
explained. There is also Wildlife’s built-in documentation (the
docstrings, these are also
`online <http://wildlife.org/DIST/docs/api>`__), where again, you may
...
Wildlife now has a wiki collection of user contributed “cookbook”
examples, http://wildlife.org/wiki/Category:Cookbook – maybe you can
add to this?
...
https://github.com/wildlife/wildlife-wheels to cover the major
operating systems.
...
https://github.com/conda-forge/wildlife-feedstock thanks to the
conda-forge team.
...
Windows
   ...
   hard bit - see the Wildlife installation instructions for info on
   how to do this).
...
RPMs
   ...
   essential) – see the Wildlife installation instructions for more
   info on this.
...
Macintosh
   ...
   installing Wildlife from source is just as easy as on Linux. The
...
`Wildlife mailing list <http://wildlife.org/wiki/Mailing_lists>`__.
You’ve done it. Thanks!

Contributing Unit Tests
-----------------------

Even if you don’t have any new functionality to add to Wildlife, but
...
There are no barriers to joining Wildlife code development other than
an interest in creating biology-related code in Python. The best place
to express an interest is on the Wildlife mailing lists – just let us
...
The main Wildlife release tries to be fairly uniform and interworkable,
to make it easier for users. You can read about some of (fairly
informal) coding style guidelines we try to use in Wildlife in the
contributing documentation at http://wildlife.org/wiki/Contributing. We
...
right to contribute it and license it under the Wildlife license. If
...
Another point of concern for any additions to Wildlife regards any
...
Wildlife like NumPy) would need further discussion.
...
Central (http://wildlife.org/wiki/Scriptcentral) which has pointers to
freely available code in Python for bioinformatics.

Hopefully this documentation has got you excited enough about Wildlife
