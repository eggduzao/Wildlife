...
``Bio.PopGen`` is a Wildlife module supporting population genetics,
available in Wildlife 1.44 onwards. The objective for the module is to
...
GenePop data files in the Test/PopGen directory of Wildlife):
...
currently being planned for Wildlife. These extensions won’t break
