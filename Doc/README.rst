...
In the Wildlife directory, install the required packages for building the documentation with::
...
The Wildlife tutorial uses its own system for testing code examples, which is located in
``Tests/test_Tutorial.py``. You can read more about this system in the testing
chapter of the Wildlife Tutorial.
