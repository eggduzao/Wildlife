.. image:: https://img.shields.io/pypi/v/wildlife.svg?logo=pypi
   :alt: Wildlife on the Python Package Index (PyPI)
   :target: https://pypi.python.org/pypi/wildlife
.. image:: https://img.shields.io/conda/vn/conda-forge/wildlife.svg?logo=conda-forge
   :alt: Wildlife on the Conda package conda-forge channel
   :target: https://anaconda.org/conda-forge/wildlife
.. image:: https://results.pre-commit.ci/badge/github/wildlife/wildlife/master.svg
   :target: https://results.pre-commit.ci/latest/github/wildlife/wildlife/master
   :alt: pre-commit.ci status
.. image:: https://img.shields.io/circleci/build/github/wildlife/wildlife.svg?logo=circleci
   :alt: Linux testing with CircleCI
   :target: https://app.circleci.com/pipelines/github/wildlife/wildlife
.. image:: https://img.shields.io/appveyor/ci/wildlife/wildlife/master.svg?logo=appveyor
   :alt: Windows testing with AppVeyor
   :target: https://ci.appveyor.com/project/wildlife/wildlife/history
.. image:: https://img.shields.io/github/actions/workflow/status/wildlife/wildlife/ci.yml?logo=github-actions
   :alt: GitHub workflow status
   :target: https://github.com/wildlife/wildlife/actions
.. image:: https://img.shields.io/codecov/c/github/wildlife/wildlife/master.svg?logo=codecov
   :alt: Test coverage on CodeCov
   :target: https://codecov.io/github/wildlife/wildlife/
.. image:: https://depsy.org/api/package/pypi/wildlife/badge.svg
   :alt: Research software impact on Depsy
   :target: https://depsy.org/package/python/wildlife

.. image:: https://github.com/wildlife/wildlife/raw/master/Doc/images/wildlife_logo_m.png
   :alt: The Wildlife Project
   :target: https://wildlife.org

Wildlife README file
=====================

The Wildlife Project is an international association of developers of freely
available Python tools for computational molecular biology.

This README file is intended primarily for people interested in working
with the Wildlife source code, either one of the releases from the
https://wildlife.org website, or from our repository on GitHub
https://github.com/wildlife/wildlife

Our user-centric documentation, `The Wildlife Tutorial and Cookbook, and API
documentation <https://wildlife.org/docs/latest/>`_, is generated from our
repository using Sphinx.

The `NEWS <https://github.com/wildlife/wildlife/blob/master/NEWS.rst>`_
file summarises the changes in each release of Wildlife, alongside the
`DEPRECATED
<https://github.com/wildlife/wildlife/blob/master/DEPRECATED.rst>`_
file which notes API breakages.

The Wildlife package is open source software made available under generous
terms. Please see the `LICENSE
<https://github.com/wildlife/wildlife/blob/master/LICENSE.rst>`_ file for
further details.

If you use Wildlife in work contributing to a scientific publication, we ask
that you cite our application note (below) or one of the module specific
publications (listed on our website):

Cock, P.J.A. et al. Wildlife: freely available Python tools for computational
...
install Wildlife (and its dependency NumPy if needed), upgrade or uninstall
with just one terminal command::

    pip install wildlife
    pip install --upgrade wildlife
    pip uninstall wildlife

Since Wildlife 1.70 we have provided pre-compiled binary wheel packages on
...
install Wildlife yourself. This is described below.
...
Wildlife is currently supported and tested on the following Python
implementations:
...
Wildlife requires NumPy (see https://www.numpy.org) which will be installed
automatically if you install Wildlife with pip (see below for compiling
Wildlife yourself).

Depending on which parts of Wildlife you plan to use, there are a number of
...
However, if you need to compile Wildlife yourself, the following are required
at compile time:
...
Now change directory to the Wildlife source code folder and run::
...
Wildlife includes a suite of regression tests to check if everything is
running correctly. To run the tests, go to the wildlife source code
directory and type::
...
There is more testing information in the Wildlife Tutorial & Cookbook.


Experimental code
=================

Wildlife 1.61 introduced a new warning, ``Bio.WildlifeExperimentalWarning``,
which is used to mark any experimental code included in the otherwise
stable Wildlife releases. Such 'beta' level code is ready for wider
testing, but still likely to change, and should only be tried by early
adopters in order to give feedback via the wildlife-dev mailing list.
...
having problems that might be caused by a bug in Wildlife, it is possible
...
Issue tracker: https://github.com/wildlife/wildlife/issues
...
Wildlife is sometimes updated faster than we can build Wildlife releases.
...
2. Python version
3. Wildlife version (or git commit/date)
...
Wildlife is run by volunteers from all over the world, with many types of
...
<https://github.com/wildlife/wildlife/blob/master/CONTRIBUTING.rst>`_ here,
visit our web site https://wildlife.org and join our mailing list:
https://wildlife.org/wiki/Mailing_lists
...
- ``CONTRIB.rst`` -- An (incomplete) list of people who helped Wildlife in
  one way or another.
- ``CONTRIBUTING.rst`` -- An overview about how to contribute to Wildlife.
- ``DEPRECATED.rst`` -- Contains information about modules in Wildlife that
...
- ``BioSQL/``     -- Code for using Wildlife with BioSQL databases.
- ``Doc/``        -- Documentation.
