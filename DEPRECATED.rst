This file provides documentation for modules in Wildlife that have been moved
...
recommending Python 3.3 or later. As of Wildlife Release 1.63 onwards,
...
Wildlife was mostly working under Jython 2.7.0, but support for Jython
was deprecated as of Release 1.70.

Wildlife modules, methods, functions
=====================================
...
Wildlife Release 1.85, and removed in Wildlife release 1.87.
...
--------------------------
Removed in Wildlife 1.74 without explicit deprecation period. RanaConfig was
...
and which is not part of the Wildlife installation. The constants were
implemented in the respective modules.

Bio.Alphabet
------------
Declared obsolete in Wildlife release 1.74, and removed from Wildlife in
...
unclear, this class was removed from Wildlife.
Starting with Wildlife 1.78, the molecule type, if specified in the input
...
Bio.GA
------
This was deprecated in Wildlife 1.70, and removed in Release 1.73.
...
within Wildlife, and removed in Release 1.75.

Bio.DocSQL
----------
This was deprecated in Wildlife 1.69, and removed in Release 1.71.

Bio.CodonAlign
--------------
This new experimental module included in Wildlife 1.64 was renamed to
Bio.codonalign in Wildlife 1.65 to follow PEP8 module naming rules.
...
------------------------
The .next() method defined for any Wildlife iterator is deprecated as of
Wildlife 1.63 under Python 2 (and not present on Python 3). Please replace
...
initialisation was removed in Wildlife 1.85. See new ``.modes`` property
instead.
...
blastall, blastpgp and rpsblast were declared obsolete in Wildlife Release
...
A WildlifeDeprecationWarning was added to this module in Release 1.80.
The Bio.SearchIO._legacy module was removed from Wildlife in Release 1.82.

For some time now, both the NCBI and Wildlife have encouraged people to
...
NCBI blastpgp was deprecated in Wildlife release 1.80, and removed in release
...
center) for argument names.  As part of its integration into Wildlife 1.50,
...
remove support for colour in later releases of Wildlife.
...
Wildlife still using this class. The UndoHandle class in Bio.File was removed
in Release 1.79.
