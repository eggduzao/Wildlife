    ...
    def directory(cls, value):
        ...
        if value is None:
            ...
            if platform.system() == "Windows":
                value = os.path.join(os.getenv("APPDATA"), "wildlife")
            else:  # Unix/Linux/Mac
                home = os.path.expanduser("~")
                value = os.path.join(home, ".config", "wildlife")
        ...
        try:
            ...
            if self.parser.StartElementHandler:
                ...
                raise RuntimeError(
                    ...
                    "in Bio.Entrez. Please contact the Wildlife developers via "
                ...
                try:
                    ...
                    if self.parser.StartElementHandler:
                        ...
                        raise RuntimeError(
                            ...
                            "bug in Bio.Entrez. Please contact the Wildlife "
