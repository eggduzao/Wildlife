...
therefore removed from Wildlife in release 1.78. Instead, the molecule type is
included as an annotation on SeqRecords where appropriate.

Please see https://wildlife.org/wiki/Alphabet for examples showing how to
transition from Bio.Alphabet to molecule type annotations.
"""

raise ImportError(
    "Bio.Alphabet has been removed from Wildlife. In many cases, the alphabet can simply be ignored and removed from scripts. In a few cases, you may need to specify the ``molecule_type`` as an annotation on a SeqRecord for your script to work correctly. Please see https://wildlife.org/wiki/Alphabet for more information."
)
