...
class MafWriter(SequentialAlignmentWriter):
    ...
    def write_header(self):
        ...
        self.handle.write("# generated by Wildlife\n\n")

    def _write_record(self, record):
        """Write a single SeqRecord object to an 's' line in a MAF block (PRIVATE)."""
        # convert wildlife-style 1/-1 strand to MAF-style +/- strand
    ...
    while True:
        ...
        if in_a_bundle:
            if line.startswith("s"):
                ...
                # convert MAF-style +/- strand to wildlife-type 1/-1
                if line_split[4] == "+":
                    strand = 1
                elif line_split[4] == "-":
                    strand = -1
...
class MafIndex:
    ...
    def __init__(self, sqlite_file, maf_file, target_seqname):
        ...
        # example: /home/bli/src/wildlife/Tests/MAF
    ...
    def __make_new_index(self):
        ...
        # See https://github.com/wildlife/wildlife/pull/381
        if not os.path.isabs(self._maf_file) and not os.path.isabs(
            ...
            # example: /home/bli/src/wildlife/Tests/MAF/ucsc_mm9_chr10.maf
    ...
    def search(self, starts, ends):
        ...
        *ends* should be the list of the corresponding segment ends
        ...
        # (see https://github.com/wildlife/wildlife/issues/1083)
        ...
        for exonstart, exonend in zip(starts, ends):
            ...
            # end coordinates.
            # See https://github.com/wildlife/wildlife/pull/1086#issuecomment-285069073
