...
the core class to deal with codon alignment in wildlife.
"""
...
class CodonAlignment(MultipleSeqAlignment):
    ...
    def __add__(self, other):
        ...
        if isinstance(other, CodonAlignment):
            ...
            warnings.warn(
                "Please make sure the two CodonAlignment objects are sharing the same codon table. This is not checked by Wildlife.",
                WildlifeWarning,
            )
            merged = (
