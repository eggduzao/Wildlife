...
"""Implementations of Wildlife-like Seq objects on top of BioSQL.

This allows retrieval of items stored in a BioSQL database using
a wildlife-like SeqRecord and Seq interface.
...
def _retrieve_features(adaptor, primary_id):
    ...
    for seqfeature_id, seqfeature_type, seqfeature_rank in results:
        ...
        if len(locations) == 0:
            ...
            # For consistency with older versions Wildlife, default to "".
            ...
            if len(strands) == 1 and -1 in strands:
                ...
                # TODO - Check if BioPerl and (old) Wildlife did the same,
            ...
            # so for consistency with older versions of Wildlife default
...
class DBSeqRecord(SeqRecord):
    """BioSQL equivalent of the Wildlife SeqRecord object."""
