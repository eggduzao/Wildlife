...
"""Connect with a BioSQL database and load Wildlife like objects from it.
    ...
    if driver in ["psycopg2", "pgdb"]:
        ...
        if server.adaptor.execute_and_fetchall(sql):
            ...
            warnings.warn(
                ...
                "cause problems loading data using Wildlife (see "
                ...
                "rules. Wildlife should cope with the rules "
